...
- [ ] Explain the differences between `client-side routing` and `server-side routing`.
      ...
      Server side routing is when clicking link or button on the page will take the user to a completely new webpage.
      Client side is when the same link or button will render a diffeernt component on the page, this changes the view
      but doesnt navigate to a new page.
